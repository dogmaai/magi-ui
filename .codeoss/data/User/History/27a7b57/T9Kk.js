...
/* ------------------------------ /compare --------------------------------- */
/**
 * 入力: { prompt, system?, providers?, models?, temperature?, timeout_ms?, max_tokens? }
 * 出力: { prompt, started_at, finished_at, results:[{provider, model, output, latency_ms, error?}] }
 */
...
/**
 * 入力: /compare と同等
 * 出力: { prompt, decidedBy, judge?, results, final }
 */
